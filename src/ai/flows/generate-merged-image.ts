...
3.  **Perform the Digital Composite:**
    *   **Complete Outfit Replacement:** Your primary task is to **completely replace** the person's original clothing with the attire shown in the "Clothing Image". No part of the original clothing should be visible.
    *   **Placement & Wrapping:** "Drape" the new clothing onto the person's body. The garment must realistically wrap around their form, following their curves and pose.
